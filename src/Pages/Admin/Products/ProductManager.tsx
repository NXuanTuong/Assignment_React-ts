                    ...
                    <table className="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="tbody-products" className="bg-white divide-y divide-gray-200">
                            {props.products.map((item) => {
                                ...
                                <td className="p-4 whitespace-nowrap text-center text-base font-medium text-gray-900">$ 150.000</td>
                                ...
                                <button type="button" onClick={() => props.onRemove(item._id)} data-modal-toggle="delete-user-modal" className="btn btn-remove text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
