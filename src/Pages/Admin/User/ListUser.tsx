                    ...
                    <table className="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="tbody-products" className="bg-white divide-y divide-gray-200">
                            {props.users.map((item, index) => {
                                ...
                                <td>
                                <div className="p-4 text-sm normal-case text-gray-900">{item.fullname}</div>
                                </td>
                                <td>
                                <div className="p-4 truncate text-center text-base font-medium text-gray-900">{item.email}</div>
                                </td>
                                <td>
                                <div className="p-4 truncate text-center text-base font-medium">{item.role == 1 ? <div className='text-yellow-500'>Admin</div> : "Thành Viên"}</div>
                                </td>
                                <td>
                                <div className="p-4 truncate text-center text-base font-medium ">{item.status == 1 ? <div className='text-green-600'>Đang sử dụng</div> : <div className='text-red-600'>Bị Khóa</div>}</div>
                                </td>
                                ...
                                <button type="button" data-modal-toggle="delete-user-modal" className="btn btn-remove text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
