    ...
    <div>
        ...
        <div className="content-cart">
            ...
            <div className="mt-10 mb-10">
                <p className="text-base font-semibold mb-2 uppercase">Shipping</p>
            ...
            <div className="mt-10 mb-10">
                <p className="text-base font-semibold mb-2 uppercase">Promo Code</p>
                <input className="px-2 py-3 w-72 rounded-lg border border-gray-300 outline-none" type="text" placeholder="Enter your code" />
                <button className="block mt-5 text-lg font-semibold border boder-gray-300 px-2 py-2 bg-red-500 w-28 text-white rounded">Apply</button>
            </div>
            <div style={{borderTop: '2px solid #ccc'}} className="w-full" />
            <div className="flex justify-between items-center mt-10 mb-10">
                ...
                <span className="text-lg font-semibold text-red-500 px-3">$</span>
                <p id="total_cart" className="text-lg font-semibold text-red-500">null</p> 
                </div>
            </div>
            <div>
                <button className="text-center px-2 py-3 text-lg font-semibold rounded bg-green-600 text-white w-full"><a href="/#/checkout">Check Out</a></button>
            </div>
            </div>
        </div>
        </div>
