...
const Signin = (props: Props) => {
  ...
  return (
    <div>
        <div className="relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: 'url(https://blog.curnonwatch.com/wp-content/uploads/2021/03/thi-truong-dong-ho-viet-nam-thumbnail-1-scaled.jpg)'}}>
        ...
        <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10">
            ...
            <div className="mt-8 content-center">
                ...
                <input {...register("password")} id="password" className="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="VD: *****" />
            </div>
            ...
            <div>
                <button className="w-full flex justify-center bg-indigo-500 text-gray-100 p-4  rounded-full tracking-wide
            ...
            <p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                ...
                <a href="/#/signin" className="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign in</a>
            </p>
            </form>
        </div>
        </div>
