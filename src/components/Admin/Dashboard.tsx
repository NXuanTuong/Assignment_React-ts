            ...
            <div className="pt-6 px-4">
                ...
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <h3 className="text-base font-normal text-gray-500">Sản phẩm mới trong tuần này
                        </h3>
                    </div>
                ...
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <h3 className="text-base font-normal text-gray-500">Khách truy cập tuần này
                        </h3>
                    </div>
                    <div className="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                        32.9%
                ...
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    ...
                    <div className="flex-shrink-0">
                        ...
                        <h3 className="text-base font-normal text-gray-500">Người dùng đăng ký trong tuần này</h3>
                    </div>
                ...
                <div className="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                    ...
                    <h3 className="text-xl font-bold leading-none text-gray-900">Khách hàng mới nhất</h3>
