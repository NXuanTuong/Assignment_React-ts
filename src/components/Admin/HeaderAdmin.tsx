    ...
    <div className="flex overflow-hidden bg-white pt-16">
        ...
        <div className="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
            ...
            <div className="flex-1 px-3 bg-white divide-y space-y-1">
                ...
                <li>
                    <Link to="users" className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-[#d7383b] hover:text-white  group ">
                ...
                <li>
                    <Link to="products" className="text-base text-gray-900 font-normal hover:text-white  hover:bg-[#d7383b] hover:text-white  rounded-lg flex items-center p-2 group ">
                    <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <Link to="category" className="text-base text-gray-900 hover:bg-[#d7383b] hover:text-white  font-normal rounded-lg group hover:bg-[#d7383b] hover:text-white  transition duration-75 flex items-center p-2">
                    <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
