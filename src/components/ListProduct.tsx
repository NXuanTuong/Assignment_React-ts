...
const ListProduct = (props: ListProductProps) => {
    ...
    const getProducts = async () => {
      if (q) {
        const { data } = await axios.get(
          `http://localhost:4000/api/product?q=${q}`
        );
        setProduct(data);
      } else {
  ...
  useEffect(() => {
    ...
    const getNextPage1 = async () => {
      const { data } = await axios.get(
        `http://localhost:4000/api/products?page=1`
      );
      setProduct(data);
    };
    getNextPage1();
            ...
            <div className="mb-16">
              ...
              <div className="border p-5 bg-[#fbf9ff] shadow-md">
                <ul>
                  {categories.map((item) => {
                    return (
                      <li className="mb-2 border-b py-2">
                        <a className="text-base cursor-pointer hover:text-red-500 font-semibold leading-4">
                          {item.name}
                        </a>
                      </li>
                    );
            ...
            <div className="mb-16">
              ...
              <div className="border p-5 bg-[#fbf9ff] shadow-md">
                ...
                >
                  <div>
                    <img
                      src="http://mauweb.monamedia.net/rolex/wp-content/uploads/2018/11/product-11_large-100x100.jpg"
                      className="w-full"
                    />
                  </div>
                  <div>
                    <p className="text-sm">BULOVA CORPORATION </p>
                    <p className="text-sm overflow-ellipsis w-40 whitespace-nowrap overflow-hidden">
                      AUTOMATIC MEN'S WATCH 49MM
                    </p>
                    <p />
                    <del className="block">
                      <span>$</span>
                      <span className="text-red-300 text-sm">130.00</span>
                    </del>
                    <span>$</span>
                ...
                <div
                  style={{ gridTemplateColumns: "1fr 2fr" }}
                  className="grid grid-cols-2 gap-3 mb-4 border-b py-2"
                >
                  <div>
                    <img
                      src="http://mauweb.monamedia.net/rolex/wp-content/uploads/2018/11/product6_20a32b81-5765-41f0-96da-606bb1ce5ed8_large-100x100.jpg"
                      className="w-full"
                    />
                  </div>
                  <div>
                    <p className="text-sm">MICHAEL KORS BRECKEN </p>
                    <p className="text-sm overflow-ellipsis w-40 whitespace-nowrap overflow-hidden">
                      CHRONOGRAPH WATCH 44MM{" "}
                    </p>
                    <p />
                    <del className="block">
                      <span>$</span>
                      <span className="text-red-300 text-sm">150.000</span>
                    </del>
                    <span>$</span>
                    <span className="font-semibold">142.300</span>
                  </div>
                </div>
                <div
                  style={{ gridTemplateColumns: "1fr 2fr" }}
                ...
                >
                  <div>
                    <img
                      src="http://mauweb.monamedia.net/rolex/wp-content/uploads/2018/11/product-23_large-100x100.jpg"
                      className="w-full"
                    />
                  </div>
                  <div>
                    ...
                    <del className="block">
                      <span>$</span>
                      <span className="text-red-300 text-sm">180.000</span>
                    </del>
                    <span>$</span>
                ...
                <div
                  style={{ gridTemplateColumns: "1fr 2fr" }}
                  className="grid grid-cols-2 gap-3 mb-4 py-2"
                >
                  <div>
                    <img
                      src="http://mauweb.monamedia.net/rolex/wp-content/uploads/2018/11/product-23_large-100x100.jpg"
                  ...
                  <div>
                    <p className="text-sm">TISSOT LE LOCLE T006 </p>
                    <p className="text-sm overflow-ellipsis w-40 whitespace-nowrap overflow-hidden">
                      AUTO WATCH 39MM
                    </p>
                    <p />
                    <del className="block">
                      <span>$</span>
                      <span className="text-red-300 text-sm">280.000</span>
                    </del>
                    <span>$</span>
                    <span className="font-semibold">275.500</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="mb-16">
              ...
              <div className="border p-5 bg-[#fbf9ff] shadow-md">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <img
                      src="http://mauweb.monamedia.net/rolex/wp-content/uploads/2018/11/15-100x100.jpg"
                      className="mb-4 w-full"
                    />
                    <img
                      src="http://mauweb.monamedia.net/rolex/wp-content/uploads/2018/11/product-11_large-100x100.jpg"
                      ...
                      <div>
                        <div>
                          <h3 className="text-base mb-2 font-semibold text-center overflow-ellipsis w-75 whitespace-nowrap overflow-hidden">
                            <Link to={`/details_product/${product._id}`}>
                              {product.name}
                            </Link>
                          </h3>
